...
class WG_oPhim_SlidePoster extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        $trendingurl = $instance['trendingurl'];
        $trendingname = $instance['trendingname'];
        $trendingthumb = $instance['trendingthumb'];
        echo $before_widget;
        ob_start();
        ?>
        <?php
    ...
    function form($instance)
    {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('trendingurl'); ?>"><?php _e('Trending URL', 'ophim') ?></label>
            <br />
            <input class="widefat" type="text" id="<?php echo $this->get_field_id('trendingurl'); ?>" name="<?php echo $this->get_field_name('trendingurl'); ?>" value="<?php echo $instance['trendingurl']; ?>" />
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('trendingname'); ?>"><?php _e('Trending Name', 'ophim') ?></label>
            <br />
            <input class="widefat" type="text" id="<?php echo $this->get_field_id('trendingname'); ?>" name="<?php echo $this->get_field_name('trendingname'); ?>" value="<?php echo $instance['trendingname']; ?>" />
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('trendingthumb'); ?>"><?php _e('Trending Thumb Url', 'ophim') ?></label>
            <br />
            <input class="widefat" type="text" id="<?php echo $this->get_field_id('trendingthumb'); ?>" name="<?php echo $this->get_field_name('trendingthumb'); ?>" value="<?php echo $instance['trendingthumb']; ?>" />
        </p>
        <p>
    ...
    public function update( $new_instance, $old_instance ) {
        ...
        $instance['trendingurl'] = $new_instance['trendingurl'];
        $instance['trendingthumb'] = $new_instance['trendingthumb'];
        $instance['trendingname'] = $new_instance['trendingname'];
        return $instance;
    }
